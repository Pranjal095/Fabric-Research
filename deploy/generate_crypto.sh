...
echo "Generating Orderer genesis and channel block (mychannel.block)..."
export FABRIC_CFG_PATH=$PWD
../build/bin/configtxgen -profile TwoOrgsApplicationGenesis -channelID mychannel -outputBlock ./mychannel.block
