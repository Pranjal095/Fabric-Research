...
class Report {
     ...
     */
    getResultColumnMap() {
        const columns = ['Name', 'Succ', 'Fail', 'Send Rate (TPS)', 'Max Latency (s)', 'Min Latency (s)', 'Avg Latency (s)', 'P95 Latency (s)', 'P99 Latency (s)', 'Throughput (TPS)'];
    ...
    getResultValues(testLabel, results) {
        ...
        resultMap.set('P95 Latency (s)', CaliperUtils.millisToSeconds(results.getP95LatencyForSuccessful()).toFixed(2));
        resultMap.set('P99 Latency (s)', CaliperUtils.millisToSeconds(results.getP99LatencyForSuccessful()).toFixed(2));
